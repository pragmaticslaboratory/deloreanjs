...
window.isTimePoint = function(element){
    ...
    element.expression.callee.object.name == 'delorean' && (element.expression.callee.property.name == 'insertTimepoint' || element.expression.callee.property.name == 'insertBreakpoint');
};
