...
module.exports = {
  ...
  invokeContinuation: kont => {
    // a = document.getElementById("input-a").value || heap.snapshots[kont-1].a || undefined;
    // b = document.getElementById("input-b").value || heap.snapshots[kont-1].b || undefined;
    // c = document.getElementById("input-c").value || heap.snapshots[kont-1].c || undefined;
    // x = document.getElementById("input-x").value || heap.snapshots[kont-1].x || undefined;
    try {
