...
export default class Term {
  constructor(type_867, props_868) {
    this.type = type_867;
    this.loc = null;
    for (let prop of Object.keys(props_868)) {
      this[prop] = props_868[prop];
    }
  }
  addScope(scope_869, bindings_870, options_871) {
    let next_872 = {};
    for (let field of fieldsIn_866(this)) {
      if (this[field] == null) {
        next_872[field] = null;
        ...
        next_872[field] = this[field].map(f_873 => f_873.addScope(scope_869, bindings_870, options_871));
      } else {
