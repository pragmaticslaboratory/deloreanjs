$(function () {
  ...
  test("should place tooltip on top of element", function () {
    ...
    setTimeout(function () {
      ...
      start();
      ok(
        tooltip.offset().top + tooltip.outerHeight() <= tooltiped.offset().top
      );
      container.remove();
    }, 100);
  });
  ...
  test("tooltips should be placed dynamically, with the dynamic placement option", function () {
    $.support.transition = false;
    var ttContainer = $('<div id="dynamic-tt-test"/>')
      .css({
        height: 400,
        overflow: "hidden",
        position: "absolute",
    ...
    ok(
      $(".tooltip").is(".top"),
      "bottom positioned tooltip is dynamically positioned top"
    );
