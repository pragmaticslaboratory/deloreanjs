$(function () {
  ...
  test("should add active class to target when collapse shown", function () {
    ...
    var target = $('<a data-toggle="collapse" href="#test1"></a>').appendTo(
      $("#qunit-fixture")
    );
  ...
  test("should remove active class from inactive accordion targets", function () {
    ...
    var collapsible1 = $('<div id="body1" class="in"></div>').appendTo(
      accordion.find(".accordion-group").eq(0)
    );
    ...
    var collapsible2 = $('<div id="body2"></div>').appendTo(
      accordion.find(".accordion-group").eq(1)
    );
