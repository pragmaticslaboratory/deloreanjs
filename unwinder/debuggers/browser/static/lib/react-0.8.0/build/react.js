...
!(function (e) {
  "object" == typeof exports
    ...
    ? (global.React = e())
    : "undefined" != typeof self && (self.React = e());
})(function () {
  ...
  return (function e(t, n, r) {
  ...
  })(
    {
      ...
      3: [
        ...
        {
          "./CSSProperty": 2,
          "./dangerousStyleValue": 82,
          "./escapeTextForBrowser": 84,
          "./hyphenate": 97,
          "./memoizeStringOnly": 106,
        },
      ],
      4: [
        function (require, module, exports) {
      ...
      6: [
        ...
        },
        {
          ...
          "./EventPropagators": 19,
          "./ExecutionEnvironment": 20,
          "./ReactInputSelection": 47,
          "./SyntheticCompositionEvent": 65,
          "./getTextContentAccessor": 95,
          "./keyOf": 105,
        },
      ],
      7: [
        ...
        function (require, module, exports) {
          ...
          var DOMProperty = {
            ...
            isCustomAttribute: function (attributeName) {
              return DOMProperty._isCustomAttributeFunctions.some(function (
                isCustomAttributeFn
              ) {
      ...
      10: [
        ...
        {
          "./ExecutionEnvironment": 20,
          "./createNodesFromMarkup": 80,
          "./emptyFunction": 83,
          "./getMarkupWrap": 92,
          "./invariant": 98,
          "./mutateHTMLNodeWithMarkup": 111,
        },
      ],
      11: [
        function (require, module, exports) {
      ...
      17: [
        function (require, module, exports) {
          ...
          function publishRegistrationName(registrationName, PluginModule) {
            ...
            EventPluginRegistry.registrationNames[
              registrationName
            ] = PluginModule;
          }
      ...
      18: [
        ...
        { "./EventConstants": 14, "./invariant": 98 },
      ],
      19: [
        function (require, module, exports) {
          /**
      ...
      22: [
        ...
        { "./EventConstants": 14, "./emptyFunction": 83 },
      ],
      23: [
        function (require, module, exports) {
          /**
      ...
      24: [
        ...
        },
        {
          ...
          "./ReactInstanceHandles": 48,
          "./ReactMount": 50,
          "./ReactMultiChild": 52,
          "./ReactPerf": 55,
          "./ReactPropTypes": 57,
          "./ReactServerRendering": 59,
          "./ReactTextComponent": 60,
        },
      ],
      25: [
        function (require, module, exports) {
          ...
          var ReactComponent = {
            ...
            Mixin: merge(ReactComponentEnvironment.Mixin, {
              ...
              updateComponent: function (transaction, prevProps) {
                ...
                if (
                  props.__owner__ !== prevProps.__owner__ ||
      ...
      26: [
                    ...
                    container &&
                      (container.nodeType === ELEMENT_NODE_TYPE ||
                        (container.nodeType === DOC_NODE_TYPE &&
                          ReactMount.allowFullPageRender)),
        ...
        },
        {
          ...
          "./ReactMarkupChecksum": 49,
          "./ReactMount": 50,
          "./ReactReconcileTransaction": 58,
          "./getReactRootElementInContainer": 94,
          "./invariant": 98,
          "./mutateHTMLNodeWithMarkup": 111,
        },
      ],
        ...
        function (require, module, exports) {
            ...
            "production" !== "development"
              ? invariant(
                  compositeLifeCycleState !==
                    CompositeLifeCycle.RECEIVING_STATE,
            ...
            for (var name in spec) {
              ...
              if (RESERVED_SPEC_KEYS.hasOwnProperty(name)) {
                ...
                var isCompositeComponentMethod =
                  name in ReactCompositeComponentInterface;
          ...
          var ReactCompositeComponentMixin = {
            ...
            updateComponent: ReactPerf.measure(
              ...
              function (transaction, prevProps, prevState) {
                ...
                if (
                  currentComponent.constructor === nextComponent.constructor
                ) {
            ...
            _bindAutoBindMethod: function (method) {
              ...
              if ("production" !== "development") {
                ...
                boundMethod.bind = function (newThis) {
                  ...
                  reboundMethod.__reactBoundArguments = Array.prototype.slice.call(
                    arguments,
                    1
                  );
          ...
          var ReactCompositeComponent = {
            ...
            isValidClass: function (componentClass) {
              return (
                componentClass instanceof Function &&
      ...
      36: [
        ...
        { "./ReactCompositeComponent": 28, "./ReactDOM": 30 },
      ],
      37: [
        function (require, module, exports) {
          /**
      ...
      38: [
        function (require, module, exports) {
          ...
          var ReactDOMSelection = {
            ...
            getOffsets: function (node) {
              var getOffsets = document.selection
                ? getIEOffsets
                : getModernOffsets;
            ...
            setOffsets: function (node, offsets) {
              var setOffsets = document.selection
                ? setIEOffsets
                : setModernOffsets;
        ...
        { "./getNodeForCharacterOffset": 93, "./getTextContentAccessor": 95 },
      ],
      39: [
        function (require, module, exports) {
          /**
      ...
      41: [
        function (require, module, exports) {
          ...
          function inject() {
            ...
            if ("production" !== "development") {
              ReactPerf.injection.injectMeasure(
                require("./ReactDefaultPerf").measure
              );
            }
        ...
        },
        {
          ...
          "./ReactDefaultPerf": 42,
          "./ReactEventEmitter": 44,
          "./ReactEventTopLevelCallback": 46,
          "./ReactInstanceHandles": 48,
          "./ReactPerf": 55,
          "./ReactUpdates": 61,
          "./SelectEventPlugin": 62,
          "./SimpleEventPlugin": 63,
        },
      ],
      42: [
        function (require, module, exports) {
          ...
          if ("production" !== "development") {
                  ...
                  return (
                    ...
                    subHistory
                      .map(function (log) {
                        ...
                        var indents =
                          "\t" +
                          Array(log.reactID.split(".[").length).join("  ");
              ...
              printRenderHistory: function (rootID, index) {
                ...
                if (!history[index]) {
                  console.warn(
                    "Index",
                    index,
                    "isn't available! " + "The render history is",
                    history.length,
                    "long."
                  );
                  return;
             ...
             * @param {object} info
             */
            var _renderComponentCallback = function (
              component,
              args,
              fnReturn,
              log,
              ...
              log.name =
                args.nextComponent.constructor.displayName || "[unknown]";
              ...
              if (ReactDefaultPerf.options.heatmap.enabled) {
                ...
                if (container.count > info.max) {
                  ...
                  info.components.forEach(function (component) {
                    _setHue(
                      component,
                      100 - (100 * component.count) / info.max
                    );
                  });
                } else {
             ...
             * @param {object} info
             */
            var _nativeComponentCallback = function (
              component,
              args,
              fnReturn,
              log,
             ...
             * @param {object} info
             */
            var _compositeComponentCallback = function (
              component,
              args,
              fnReturn,
              log,
          ...
          var ReactEventEmitter = merge(ReactEventEmitterMixin, {
            ...
            listenAtTopLevel: function (touchNotMouse, contentDocument) {
              ...
              if (isEventSupported("drag")) {
                ...
                trapBubbledEvent(
                  topLevelTypes.topDragEnter,
                  "dragenter",
                  mountAt
                );
                trapBubbledEvent(
                  topLevelTypes.topDragExit,
                  "dragexit",
                  mountAt
                );
                trapBubbledEvent(
                  topLevelTypes.topDragLeave,
                  "dragleave",
                  mountAt
                );
                trapBubbledEvent(
                  topLevelTypes.topDragOver,
                  "dragover",
                  mountAt
                );
                trapBubbledEvent(
                  topLevelTypes.topDragStart,
                  "dragstart",
                  mountAt
                );
      ...
      45: [
          ...
          var ReactEventEmitterMixin = {
            ...
            ensureListening: function (config) {
              if (!config.contentDocument._reactIsListening) {
                this.listenAtTopLevel(
                  config.touchNotMouse,
        ...
        { "./EventPluginHub": 16, "./ReactUpdates": 61 },
      ],
      46: [
        function (require, module, exports) {
          /**
          ...
          var ReactEventTopLevelCallback = {
            ...
            createTopLevelCallback: function (topLevelType) {
              return function (nativeEvent) {
                ...
                var topLevelTarget =
                  ReactMount.getFirstReactDOM(getEventTarget(nativeEvent)) ||
                  window;
          ...
          var ReactMount = {
            ...
            renderComponent: function (nextComponent, container, callback) {
              ...
              if (registeredComponent) {
                if (
                  registeredComponent.constructor === nextComponent.constructor
                ) {
              ...
              var shouldReuseMarkup =
                containerHasReactMarkup && !registeredComponent;
                ...
                while (child) {
                  ...
                  if (childID) {
                    if (id === childID) {
                      ...
                      ReactInstanceHandles.isAncestorIDOf(childID, id)
                    ) {
        ...
        function (require, module, exports) {
          ...
          function shouldUpdateChild(curChild, newChild) {
            return (
              curChild &&
              newChild &&
              curChild.constructor === newChild.constructor
            );
          }
        ...
        function (require, module, exports) {
          ...
          if ("production" !== "development") {
            ...
            ReactPerf.enableMeasure =
              ReactPerf.enableMeasure || /[?&]react_perf\b/.test(url);
          }
      ...
      57: [
        ...
        { "./createObjectFrom": 81, "./invariant": 98 },
      ],
      58: [
        function (require, module, exports) {
          /**
      ...
      63: [
        ...
        },
        {
          "./EventConstants": 14,
          "./EventPropagators": 19,
          "./SyntheticClipboardEvent": 64,
          "./SyntheticEvent": 66,
          "./SyntheticFocusEvent": 67,
          "./SyntheticKeyboardEvent": 68,
          "./SyntheticMouseEvent": 69,
          "./SyntheticTouchEvent": 70,
          "./SyntheticUIEvent": 71,
          "./SyntheticWheelEvent": 72,
          "./invariant": 98,
          "./keyOf": 105,
        },
      ],
      ...
      69: [
        ...
        { "./SyntheticUIEvent": 71, "./ViewportMetrics": 74 },
      ],
      70: [
        function (require, module, exports) {
          /**
            ...
            initializeAll: function () {
              ...
              for (var i = 0; i < transactionWrappers.length; i++) {
                ...
                try {
                  ...
                  wrapperInitTimes[i] =
                    (curInitTime || 0) + (initEnd - initStart);
                }
              }
              if (errorToThrow) {
                throw errorToThrow;
            ...
            closeAll: function () {
              ...
              for (var i = 0; i < transactionWrappers.length; i++) {
                ...
                try {
                  ...
                  wrapperCloseTimes[i] =
                    (curCloseTime || 0) + (closeEnd - closeStart);
                }
              }
              this.wrapperInitData.length = 0;
              this._isInTransaction = false;
        ...
        function (require, module, exports) {
          ...
          function dangerousStyleValue(styleName, value) {
            ...
            if (
              isNonNumeric ||
              value === 0 ||
              CSSProperty.isUnitlessNumber[styleName]
            ) {
      ...
      87: [
        ...
        { "./invariant": 98, "./traverseAllChildren": 116 },
      ],
      88: [
        function (require, module, exports) {
          /**
      ...
      92: [
        ...
        { "./ExecutionEnvironment": 20, "./invariant": 98 },
      ],
      93: [
        function (require, module, exports) {
          /**
          ...
          var mergeHelpers = {
            ...
            checkArrayStrategy: function (strategy) {
              "production" !== "development"
                ? invariant(
                    strategy === undefined ||
                      strategy in mergeHelpers.ArrayStrategies,
        ...
        function (require, module, exports) {
          ...
          function mutateHTMLNodeWithMarkup(node, markup) {
            ...
            if (shouldExtractAttributes) {
              ...
              var attributesToSet = filterAttributes(attributeHolder, function (
                attr
              ) {
                return (
                  node.getAttributeNS(attr.namespaceURI, attr.name) !==
                  attr.value
                );
              });
