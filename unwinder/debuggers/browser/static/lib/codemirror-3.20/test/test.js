...
testCM(
  ...
  function (cm) {
    ...
    is(
      new01.left == pos01.left && new01.top == pos01.top,
      "at left, middle of line"
    );
    is(
      new11.left > pos11.left && new11.top == pos11.top,
      "at right, middle of line"
    );
    is(
      new20.left == pos20.left && new20.top == pos20.top,
      "at left, empty line"
    );
    is(
      new30.left > pos30.left && new30.top == pos30.top,
      "at right, empty line"
    );
...
testCM(
  ...
  function (cm) {
    ...
    add(true);
    is(Math.abs(base1 - cm.cursorCoords(Pos(0, 1)).left) < 0.1);
    while ((m = ms.pop())) m.clear();
    add(false);
    is(Math.abs(base4 - cm.cursorCoords(Pos(0, 1)).left) < 0.1);
  },
  { value: "abcdefg" }
);
