(function () {
  ...
  MT("atxH1", "[header&header1 # foo]");

  MT("atxH2", "[header&header2 ## foo]");

  MT("atxH3", "[header&header3 ### foo]");

  MT("atxH4", "[header&header4 #### foo]");

  MT("atxH5", "[header&header5 ##### foo]");

  MT("atxH6", "[header&header6 ###### foo]");

  // H6 - 7x '#' should still be H6, per Dingus
  // http://daringfireball.net/projects/markdown/dingus
  MT("atxH6NotH7", "[header&header6 ####### foo]");

  // Inline styles should be parsed inside headers
  MT("atxH1inline", "[header&header1 # foo ][header&header1&em *bar*]");
  ...
  MT("setextH1", "foo", "[header&header1 =]");

  // Check if 3+ ='s work
  MT("setextH1", "foo", "[header&header1 ===]");

  // Check if single underlining - works
  MT("setextH2", "foo", "[header&header2 -]");
