...
{\bf {\em Disponibilidad.}} El c\'odigo fuente de la implementaci\'on de \deloreanjs se encuentra en {\tt \url{http://github.com/fruizrob/delorean}} y una prueba de concepto de su aplicaci\'on se puede encontrar como extensi\'on de Google Chrome en {\tt \url{http://xxx.com}}. 
...
\parhead{Guardar completamente el heap}

\smallskip

\parhead{Incluir en otro debugger}
