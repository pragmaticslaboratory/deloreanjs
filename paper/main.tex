...
Un timepoint tambi\'en necesita capturar y almacenar las variables que se encuentran en el heap, pero una continuaci\'on no lo captura. Para lograrlo, \deloreanjs realiza un an\'alisis est\'atico antes de ejecutar el programa para registrar las variables del heap marcadas por el programador y quienes depende de ellas. A continuaci\'on, explicamos este proceso en m\'as detalle.  
