...
\caption{Las tres etapas para capturar las variables observadas (ej. \co{x} y \co{z}) y las variables que pueden modificar a ellas (ej. \co{a} porque modifica \co{z}).}
\label{fig:heap1}
\end{center}
\end{figure}
