...
{\bf {\em Disponibilidad.}} El c\'odigo fuente de la implementaci\'on de \deloreanjs se encuentra en {\tt \url{http://github.com/fruizrob/delorean}} y los ejemplos presentados aqu\'i se pueden probar online sin la necesidad de una ninguna extensi\'on en {\tt \url{http://pleger.cl/delorean/playground/}}.
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=1\linewidth]{fig-heap}
\caption{Proceso para guardar las variables marcadas por el programdor y quienes dependen de ellas.}
\label{fig:heap}
\end{center}
\end{figure}

Un timepoint necesita guardar las variables que se encuentran en el heap y la abstracci\'on de continuaci\'on no lo realiza. Para lograrlo, \deloreanjs realiza un an\'alisis est\'atico antes de ejecutar el programa para marcar las variables del heap marcadas por el programador y quienes depende de ellas. A continuaci\'on, explicamos este proceso en m\'as detalle.  


Para capturar y guardar las variables marcadas por el desarrollador, se 
...
\pl{Explicar la aplicaci\'on cuando se interactua con el desarrollador y extensi\'on en Google Chrome}
